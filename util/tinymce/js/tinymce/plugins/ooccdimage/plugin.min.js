tinymce.PluginManager.add('ooccdimage', function(editor, url) {
  ...
  editor.addButton('ooccdimage', {
    text: '2D',
    tooltip: '2D ChemDoodle Stucture/PNG (Static)',
    icon: false,
    onclick: function() {
      // Open window
      var win = editor.windowManager.open({
        title: 'Draw structure below',
